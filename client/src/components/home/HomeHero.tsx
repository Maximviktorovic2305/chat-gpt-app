...
const HomeHero = () => {
  return (
    <div className="relative size-full text-[2vw] min-h-[270px]">
      ...
      <h1 className="absolute max-sm:text-[3em] text-nowrap leading-[110%] text-white/80 top-[35%] left-[9%] transform text-[48px]">ChatGPT и Mistral без VPN <br />на русском языке</h1>
